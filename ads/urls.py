...
from .views import (AdList, AdDetail, AdCreate, AdUpdate, AdDelete, SearchAd, MyAdsList,
                    CategoryList, show_category,
                    ReplyAdList, ReplyDetail, ReplyCreate, confirm_reply, reject_reply, MyReplyList
)
